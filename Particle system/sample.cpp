...
const char* WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Han-Hsing Pao" };
...
Display()
{
	...
	{
		char str[128];
		sprintf(str, "%6.8f GigaParticles/Sec", (float)NUM_PARTICLES / ElapsedTime / 1000000000.);
...
/*
	...
	glPopMatrix();
*/
	glColor3f(.5f, 0.f, .5f);	// 0. <= r,g,b <= 1.
	glPushMatrix();
	glTranslatef(-100.f, -800.f, 0.f);
	glutWireSphere(200.f, 100, 100);
	glPopMatrix();

	glColor3f(.0f, 0.6f, .5f);	// 0. <= r,g,b <= 1.
	glPushMatrix();
	glTranslatef(700.f, -800.f, 0.f);
	glutWireSphere(200.f, 100, 100);
	glPopMatrix();

	glColor3f(1.f, 8.f, 0.f);	// 0. <= r,g,b <= 1.
	glPushMatrix();
	glTranslatef(300.f, -800.f, 0.f);
	glutWireSphere(200.f, 100, 100);
	glPopMatrix();

	glColor3f(.0f, 0.1f, .8f);	// 0. <= r,g,b <= 1.
	glPushMatrix();
	glTranslatef(-500.f, -800.f, 0.f);
	glutWireSphere(200.f, 100, 100);
	glPopMatrix();
	// ****************************************
